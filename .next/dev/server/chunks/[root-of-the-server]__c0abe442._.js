...
async function handler(req, res) {
    ...
    try {
        ...
        do {
            ...
            const result = await query('SELECT slug FROM urls WHERE slug = $1', [
                slug
            ]);
            exists = result.rows.length > 0;
        }while (exists)
        await query('INSERT INTO urls (slug, original_url) VALUES ($1, $2)', [
            slug,
            url
        ]);
        res.status(200).json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0abe442._.js.map